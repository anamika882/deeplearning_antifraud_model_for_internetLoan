...
def View_primary_stage_of_diabetes_prediction(request):
    if request.method == "POST":
        ...
        return render(request, 'RUser/View_primary_stage_of_Internet Loan_prediction.html', {'objs': val})
    return render(request, 'RUser/View_primary_stage_of_Internet Loan_prediction.html')
